...
class FretboardFlowAugmented(FretboardFlow):
    """
    ...
    def __init__(self, root_dir, history_length=3, fs=100, cache_dir='./data'):
        super().__init__(root_dir, history_length=history_length, fs=f)
        ...
        self.processed_data_path = os.path.join(cache_dir, f"processed_ff_aug_data_hlen_{history_length}.pkl")
    ...
    def _shift_sample(self, sample, shift=-1):
        ...
        """
        (chords_input, frets_prev_input, frets_target, uncertainty_mask,
         song_id, version, textual_chords) = sample
